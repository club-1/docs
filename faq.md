...
La seule manière de modifier son mot de passe de membre CLUB1
...
Il n'est pas possible pour les membres de modifier leur [identifiant CLUB1](./info/general.md#identifiant).
...
Il est cependant possible de créer un nouveau compte avec un autre identifiant
et d'y déplacer petit-à-petit ses projets.
