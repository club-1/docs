...
Serveur
   ...
   Souvent, les serveurs et les clients sont installés sur des ordinateurs différentes.
   Par extension, on appelle ainsi un "serveur" l'ordinateur sur laquelle les
